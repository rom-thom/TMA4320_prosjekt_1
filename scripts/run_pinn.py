...
def main():
    ...
    plt.plot(cfg.lambda_data * losses["data"][20:], label="Loss data")
    plt.plot(cfg.lambda_ic * losses["ic"][20:], label="Loss ic")
    plt.plot(cfg.lambda_physics * losses["physics"][20:], label="Loss physics")
    plt.plot(cfg.lambda_bc * losses["bc"][20:], label="Loss bc")
    plt.xlabel("epoch nr.")
